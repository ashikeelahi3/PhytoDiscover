  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="shrink-0 w-8 h-8 flex items-center justify-center rounded-md transition-colors cursor-pointer"
        style={{
      ...
      >
        {mounted ? (resolvedTheme === "dark" ? <SunIcon /> : <MoonIcon />) : <SunIcon />}
      </button>
    </nav>
  );
}
